...
def save_to_hdf5(h5_file, img_files, labels, target_size=(64, 64), batch_size=1000):
    """Lưu ảnh vào HDF5"""
...
def main():
    ...
    if not os.path.exists('utkface_train.h5'):
        with h5py.File('utkface_train.h5', 'w') as h5f:
            ...
            save_to_hdf5(h5f, train_files, train_labels, target_size, args.batch_size)
    ...
    if not os.path.exists('utkface_test.h5'):
        with h5py.File('utkface_test.h5', 'w') as h5f:
            ...
            save_to_hdf5(h5f, test_files, test_labels, target_size, args.batch_size)
